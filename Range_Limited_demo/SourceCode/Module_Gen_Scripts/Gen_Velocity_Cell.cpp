...
int Gen_Velocity_Cell(int cellx, int celly, int cellz, std::string* common_path){
	...
	fout << "/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////\n";
	fout << "// Module: velocity_"<< cellx <<"_"<< celly <<"_"<< cellz <<".v\n";
	fout << "//\n";
	fout << "//	Function:\n";
	...
	fout << "//\n";
	fout << "// Used by:\n";
	fout << "//\t\t\t\tVelocity_Cache_" << cellx <<  "_" << celly << "_" << cellz << ".v\n";
	fout << "//\n";
	fout << "// Dependency:\n";
	fout << "//\t\t\t\tvelocity_ini_file_"<< cellx <<"_"<< celly <<"_"<< cellz <<".hex / velocity_ini_file_"<< cellx <<"_"<< celly <<"_"<< cellz <<".mif\n";
	fout << "//\n";
	fout << "// Testbench:\n";
	fout << "//\t\t\t\tRL_LJ_Top_tb.v\n";
	fout << "//\n";
	...
	fout << "\t\taltera_syncram_component.init_file = \"/home/chunshu/Documents/Legacy/SourceCode/cell_ini_file_"<< cellx <<"_"<< celly <<"_"<< cellz <<".hex\"\n";
	fout << "`elsif STX_PATH\n";
