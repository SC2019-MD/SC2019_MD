...
int Gen_Pos_Cache(int cellx, int celly, int cellz, std::string* common_path){

	// Setup Generating file
	char filename[100];
	sprintf(filename,"Pos_Cache_%d_%d_%d.v", cellx, celly, cellz);
	...
	fout << "/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////\n";
	fout << "// Module: Pos_Cache_"<< cellx <<"_"<< celly <<"_"<< cellz <<".v\n";
	fout << "//\n";
	fout << "//	Function:\n";
	fout << "//\t\t\t\tPosition cache with double buffering for motion update\n";
	fout << "//\n";
	fout << "//	Purpose:\n";
	...
	fout << "//\t\t\t\tPosition data: MSB-LSB: {posz, posy, posx}\n";
	...
	fout << "//\n";
	fout << "// Testbench:\n";
	fout << "//\t\t\t\tPos_Cache_2_2_2_tb.v			(testing the swap function during motion update)\n";
	...
	fout << "//\n";
	fout << "// Created by:\n";
	fout << "//\t\t\t\tChunshu's Script (Gen_Pos_Cache.cpp).\n";
	fout << "/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////\n\n";
	
	fout << "module Pos_Cache_"<< cellx <<"_"<< celly <<"_"<< cellz <<"\n";
	fout << "#(\n";
	...
	fout << "\tcell_"<< cellx <<"_"<< celly <<"_"<< cellz <<"\n";
	fout << "\t#(\n";
	...
	for (i = 0; i < CELL_NUM_X; i++) {
		for (j = 0; j < CELL_NUM_Y; j++) {
			for (k = 0; k < CELL_NUM_Z; k++) {
				Gen_Pos_Cache(i+1, j+1, k+1, &common_src_path);
			}
		}
	}
	return 0;
