...
while line_counter <= TOTAL_PARTICLE_NUM
    ...
    pos(line_counter,1) = line_elements{7} * SCALE_INDEX;
    pos(line_counter,2) = line_elements{8} * SCALE_INDEX;
    pos(line_counter,3) = line_elements{9} * SCALE_INDEX;
