/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Module: RL_Evaluation_Unit.v
//
//	Function: 
//				Evaluate the accumulated Range Limited force of given datasets using 1st order interpolation (interpolation index is generated in Matlab (under Ethan_GoldenModel/Matlab_Interpolation))
...
//
// Dependency:
//				RL_Force_Evaluation_Unit.v / RL_Force_Evaluation_Unit_simple_filter.v
//				Partial_Force_Acc.v
//
// Testbench:
//				RL_Top_tb.v
...
//				RL_LJ_Force_Evaluation_Unit:				34 cycles
//				Partial_Force_Acc:							currently 1 cycle
//
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

module RL_Evaluation_Unit
#(
...
(
	...
	output [DATA_WIDTH-1:0] out_ref_RL_Force_X,
	output [DATA_WIDTH-1:0] out_ref_RL_Force_Y,
	output [DATA_WIDTH-1:0] out_ref_RL_Force_Z,
	...
	output [DATA_WIDTH-1:0] out_neighbor_RL_Force_X,
	output [DATA_WIDTH-1:0] out_neighbor_RL_Force_Y,
	output [DATA_WIDTH-1:0] out_neighbor_RL_Force_Z,
	...
	*/
	...
	assign out_neighbor_RL_Force_X = RL_Force_X_wire ^ 32'h80000000;
	assign out_neighbor_RL_Force_Y = RL_Force_Y_wire ^ 32'h80000000;
	assign out_neighbor_RL_Force_Z = RL_Force_Z_wire ^ 32'h80000000;
	...
	(
		...
		.out_RL_Force_X(RL_Force_X_wire),												// OUTPUT [DATA_WIDTH-1:0]
		.out_RL_Force_Y(RL_Force_Y_wire),												// OUTPUT [DATA_WIDTH-1:0]
		.out_RL_Force_Z(RL_Force_Z_wire),												// OUTPUT [DATA_WIDTH-1:0]
...
/*	RL_Force_Evaluation_Unit_simple_filter
	#(
		.DATA_WIDTH(DATA_WIDTH),
		// Dataset defined parameters
		.PARTICLE_ID_WIDTH(PARTICLE_ID_WIDTH),							// # of bit used to represent particle ID, 9*9*7 cells, each 4-bit, each cell have max of 200 particles, 8-bit
	...
	(
		...
		.RL_Force_X(RL_Force_X_wire),												// OUTPUT [DATA_WIDTH-1:0]
		.RL_Force_Y(RL_Force_Y_wire),												// OUTPUT [DATA_WIDTH-1:0]
		.RL_Force_Z(RL_Force_Z_wire),												// OUTPUT [DATA_WIDTH-1:0]
...
*/	
	...
	(
		...
		.in_partial_force_x(RL_Force_X_wire),
		.in_partial_force_y(RL_Force_Y_wire),
		.in_partial_force_z(RL_Force_Z_wire),
		.out_particle_id(out_ref_particle_id),
		.out_particle_acc_force_x(out_ref_RL_Force_X),
		.out_particle_acc_force_y(out_ref_RL_Force_Y),
		.out_particle_acc_force_z(out_ref_RL_Force_Z),
