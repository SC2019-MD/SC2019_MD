...
int Gen_Boundary_Mem(std::string* common_path){
	...
	std::string filename = "cell_boundary_mem.v";
	...
	fout << "/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////\n";
	fout << "// Module: cell_boundary_mem.v\n";
	fout << "//\n";
	fout << "//	Function:\n";
	fout << "//\t\t\t\tMemory modules holding the cell boundary information in IEEE floating point\n";
	fout << "//\n";
	fout << "//	Purpose:\n";
	fout << "//\t\t\t\tProviding cell boundary information for motion update units when determine target cells\n";
	fout << "//\n";
	fout << "// Data Organization:\n";
	fout << "//\t\t\t\tUse cell_id as lookup address\n";
	fout << "//\t\t\t\tSuppose the cell size in each dimension is the same, then use one memory module for all 3 dimensions\n";
	fout << "//\t\t\t\tCell id starts from 1, but memory address starts from 0\n";
	fout << "//\t\t\t\tFor example, for cell id = 1, the low boundary is at address 0, upper boundary is at address 1\n";
	fout << "//\n";
	fout << "// Used by:\n";
	fout << "//\t\t\t\tMotion_Update.v\n";
	fout << "//\n";
	fout << "// Dependency:\n";
	fout << "//\t\t\t\tcell_ini_boundary_value.hex / cell_ini_boundary_value.mif\n";
	fout << "//\n";
	fout << "// Testbench:\n";
	fout << "//\t\t\t\tRL_LJ_Top_tb.v\n";
	fout << "//\n";
	...
	fout << "//\n";
	fout << "// Created by:\n";
	fout << "//\t\t\t\tChen Yang's Script (Gen_Boundary_Mem.cpp), based on Single Port RAM IP core\n";
	fout << "//\t\t\t\tInitialization file is generated by matlab script GenCellBoundary_ApoA1.m\n";
	fout << "/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////\n\n";
	...
	fout << "module cell_boundary_mem\n";
	fout << "#(\n";
	fout << "\tparameter DATA_WIDTH = 32,\n";
	fout << "\tparameter DEPTH = 10,\n";
	fout << "\tparameter ADDR_WIDTH = 4\n";
	fout << ")\n";
	fout << "(\n";
	fout << "\taddress,\n";
	fout << "\tclock,\n";
	...
	fout << "\t\taltera_syncram_component.init_file = \"F:/Dropbox/CAAD_Server/MD_RL_Pipeline/Ethan_RL_Pipeline_1st_Order_SingleFloat_18.0/SourceCode/cell_ini_boundary_value.hex\"\n";
	fout << "`elsif STX_PATH\n";
	fout << "\t\taltera_syncram_component.init_file = \"/home/vsachde/Dropbox/CAAD_Server/MD_RL_Pipeline/Ethan_RL_Pipeline_1st_Order_SingleFloat_18.0/SourceCode/cell_ini_boundary_value.hex\"\n";
	fout << "`elsif STX_2ND_PATH\n";
	fout << "\t\taltera_syncram_component.init_file = \"/home/vsachde/Dropbox/CAAD_Server/MD_RL_Pipeline/MD_HDL_STX/SourceCode/cell_ini_boundary_value.hex\"\n";
	fout << "`else\n";
	fout << "\t\taltera_syncram_component.init_file = \""<< *common_path << "/cell_ini_boundary_value.hex\"\n";
	fout << "`endif\n";
	fout << ",\n";
