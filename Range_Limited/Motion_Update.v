...
(
	...
	output reg out_motion_update_enable,											// Remine high during the entire motion update process
	...
	always@(*)
		...
		if(~meet_low_boundary_x)
			target_cell_x = out_cur_working_cell_x - 1'b1;
	...
	always@(*)
		...
		if(~meet_low_boundary_y)
			target_cell_y = out_cur_working_cell_y - 1'b1;
	...
	always@(*)
		...
		if(~meet_low_boundary_z)
			target_cell_z = out_cur_working_cell_z - 1'b1;
